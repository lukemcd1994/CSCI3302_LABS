...
if __name__ == "__main__":
  ...
  parser.add_argument('-x', '--goal_x', type=float, nargs=1, default=[5], help='Goal x coordinate')
  parser.add_argument('-y', '--goal_y', type=float, nargs=1, default=[0], help='Goal y coordinate')
  parser.add_argument('-theta', '--goal_theta', type=float, nargs=1, default=[-3], help='Goal theta orientation')
